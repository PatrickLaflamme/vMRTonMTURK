...
jsPsych.plugins["single-stim-delay"] = (function() {

  var plugin = {};

  jsPsych.pluginAPI.registerPreload('single-stim-delay', 'stimulus', 'image');
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var end_trial = function() {
      ...
      var trial_data = {
        "rt": response.rt - trial.delay_stim,
    ...
    if ((trial.delay_stim + trial.timing_stim) > 0) {
